...
function formatPage(body, tblMaster) {
...
function formatPost(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatPersonalDetails(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatBasicDegree(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatPostgraduateDegree(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatResearch(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatAwards(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatExtraCurricular(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatPresentEmployment(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatPreviousEmployement(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatRefrees(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatDeclaration(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function formatApplicantSignature(table, styles) {
  table.setAttributes(styles.tableStyle.remove);
...
function generateApplicantSignature(table) {
  const cell1 = table.getCell(0, 0);
  cell1.insertParagraph(
    0,
...
function generateOfficeSignature(table) {
  const cell1 = table.getCell(0, 0);
